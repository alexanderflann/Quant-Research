...
```python
def solve_for_iv(S, E, T, r, price, q, option_type, sigma_guess = 0.8, N_iter = 20, epsilon = 0.001, verbose = True): # Function to solve for the implied volatility iteratively using the Newton-Raphson method
